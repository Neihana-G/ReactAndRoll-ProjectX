                ...
                <div className={styles.mainSection}>
                    ...
                    <div className={styles.rightSection}>
                        ...
                        <p className={styles.welcome}>
                            Welcome to the project library. You can use the
                            filters on the right to help you search for specific
                            projects.
                        </p>
                                ...
                                {difficulties.map((difficulty, index) => {
                                    return (
                                        ...
                                        >
                                            ...
                                            <div
                                                className={
                                                    styles.control_difficulty_text
                                                }
                                            >
                                                {difficulty}
                                            </div>
