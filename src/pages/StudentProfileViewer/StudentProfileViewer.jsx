      ...
      <div className={styles.mainProfile}>
        ...
        <div className={styles.bodyProfile}>
          <div className={styles.profileLeft}>
            <img src={studentPhoto} className={styles.profilePhoto} />
          ...
          <div className={styles.profileRight}>
            ...
            <div className={styles.details}>
              ...
              <div>
                <p className={styles.detailsText}>Homai School</p>
                <p className={styles.detailsText}>Jasmina Salvador</p>
                <p className={styles.detailsText}>Beginner</p>
                <p className={styles.detailsText}>25 June 2010</p>
                <p className={styles.detailsText}>022 524 63 99</p>
                <p className={styles.detailsText}>fletchy.r@gmail.com</p>
              </div>
            </div>
