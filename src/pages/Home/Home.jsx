    ...
    return (
        <>
            ...
            <div>
                <HomeHeader
                    signedIn={false}
                    profileFunction={handleModalOpenClose}
                />
                ...
                <section className={styles.section_2}>
                    <div className={styles.sec2_container}>
                        <div>
                            <h3>What we offer</h3>
                            <p>
                                The Creative Problem Solving programme is series
                                of digital creation projects aimed to encourage
                                self-motivation and student agency, designed by
                                New Zealand’s leading IT industry experts and
                                schools.
                            </p>
